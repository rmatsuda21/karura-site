...
const engineeringModal = `
  <div class="engineering">
    ...
    <p>
      早稲田大学創造理工学部の学生である三木 隆史がリーダーを
      務めるKARURAのエンジニアリングチームは、
      宇宙探査分野での作業の 支援やデータ分析に使用されるマーズ・ローバー（火星探査機） 
      をゼロから設計・構築する 作業を行っています。
    </p>
    <p>
      KARURAのエンジニアリングチームには 各国のトップ大学のエンジニアが集まっています。
      全米ランキング7位のテキサスA&M工学校からは、 コンピュータサイエンス、航空宇宙工学、
      機械工学など さまざまな分野のエンジニアが15名以上参加しています。
    </p>
    <p>
      日本支部のエンジニアリング部門では、主に東京大学、 信州大学、
      早稲田大学などからエンジニアが 参加しています。
    </p>
